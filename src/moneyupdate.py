...
def update():
    ...
    if up>=100 and up<1000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 40, 20))
    if up>=10 and up<100:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 40, 20))
    if up>=1000 and up<10000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 80, 20))
    if up>=10000 and up<100000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 80, 20))
    if up>=100000 and up<1000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 100, 20))
    if up>=1000000 and up<10000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 120, 20))
    if up>=10000000 and up<100000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 140, 20))
    if up>=100000000 and up<1000000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 160, 20))
    if up>=1000000000 and up<10000000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 120, 20))
    if up>=10000000000 and up<100000000000:
        pygame.draw.rect(mwin, (86, 213, 47),(735, 90, 120, 20))
